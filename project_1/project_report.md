...
After submitting predictions to Kaggle, score did not improved: from previous best score of **0.62078** current score improved to **0.49307**. Conclusion: together with ensembling techniques, models hyperparameter tuning significanlty improves performance. 
